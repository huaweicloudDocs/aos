...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <td class="cellrowborder" valign="top" width="50.16501650165017%" headers="mcps1.2.4.1.3 "><p id="p3177121061013"><a name="p3177121061013"></a><a name="p3177121061013"></a><span id="ph8516124931420"><a name="ph8516124931420"></a><a name="ph8516124931420"></a>数组元素为每个模板的所有版本详细信息</span>，详情请参见<a href="#table5418744154017">表3</a>。</p>
    </td>
    </tr>
