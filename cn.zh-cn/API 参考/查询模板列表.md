...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <td class="cellrowborder" valign="top" width="50.16501650165017%" headers="mcps1.2.4.1.3 "><p id="p3177121061013"><a name="p3177121061013"></a><a name="p3177121061013"></a><span id="ph24231432171419"><a name="ph24231432171419"></a><a name="ph24231432171419"></a>数组元素为模板详细信息</span>，详情请参见<a href="#table5418744154017">表3</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 4**  响应消息头
    ...
    <table><thead align="left"><tr id="row6748101751814"><th class="cellrowborder" valign="top" width="21.060000000000002%" id="mcps1.2.5.1.1"><p id="p1335893514314"><a name="p1335893514314"></a><a name="p1335893514314"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="19.5%" id="mcps1.2.5.1.2"><p id="p13584350317"><a name="p13584350317"></a><a name="p13584350317"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="18.45%" id="mcps1.2.5.1.3"><p id="p23581635183120"><a name="p23581635183120"></a><a name="p23581635183120"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="40.99%" id="mcps1.2.5.1.4"><p id="p7358113573117"><a name="p7358113573117"></a><a name="p7358113573117"></a>描述</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row15749717141813"><td class="cellrowborder" valign="top" width="21.060000000000002%" headers="mcps1.2.5.1.1 "><p id="p1374941701812"><a name="p1374941701812"></a><a name="p1374941701812"></a>Content-Range</p>
    </td>
    <td class="cellrowborder" valign="top" width="19.5%" headers="mcps1.2.5.1.2 "><p id="p37491017111811"><a name="p37491017111811"></a><a name="p37491017111811"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.45%" headers="mcps1.2.5.1.3 "><p id="p14749151741816"><a name="p14749151741816"></a><a name="p14749151741816"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="40.99%" headers="mcps1.2.5.1.4 "><p id="p274981714180"><a name="p274981714180"></a><a name="p274981714180"></a>分页信息，items为起始和终止，以及总数”。具体取值依赖于用户的模板数量。</p>
