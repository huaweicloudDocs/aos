...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <td class="cellrowborder" valign="top" width="45.45544554455446%" headers="mcps1.2.4.1.3 "><p id="p1249362571218"><a name="p1249362571218"></a><a name="p1249362571218"></a>元素的关系，详情请参见<a href="#table136551348103520">表3</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="45.45544554455446%" headers="mcps1.2.4.1.3 "><p id="p77551671336"><a name="p77551671336"></a><a name="p77551671336"></a>堆栈元素当前的状态，详情请参见<a href="查询堆栈列表.md#table136551348103520">表12</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
