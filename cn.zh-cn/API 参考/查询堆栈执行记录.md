...
<td class="cellrowborder" valign="top" width="40.78%" headers="mcps1.2.5.1.4 "><p id="p87492071011"><a name="p87492071011"></a><a name="p87492071011"></a>执行记录的名称(name)，长度[1, 64]。</p>
</td>
</tr>
</tbody>
</table>
...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <tbody><tr id="row361041195717"><td class="cellrowborder" valign="top" width="19.981998199819984%" headers="mcps1.2.4.1.1 "><p id="p466411572"><a name="p466411572"></a><a name="p466411572"></a>metadata</p>
    </td>
