...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <tbody><tr id="row817611107107"><td class="cellrowborder" valign="top" width="25.252525252525253%" headers="mcps1.2.4.1.1 "><p id="p1148961113219"><a name="p1148961113219"></a><a name="p1148961113219"></a><span id="ph1014812554314"><a name="ph1014812554314"></a><a name="ph1014812554314"></a>[自定义key]</span></p>
    </td>
    <td class="cellrowborder" valign="top" width="24.582458245824583%" headers="mcps1.2.4.1.2 "><p id="p7177810101016"><a name="p7177810101016"></a><a name="p7177810101016"></a><span id="ph171507551739"><a name="ph171507551739"></a><a name="ph171507551739"></a>Map&lt;String,Object&gt;</span></p>
    </td>
    ...
    **表 3** 模板输入参数属性信息字段说明
    ...
    <td class="cellrowborder" valign="top" width="46.88%" headers="mcps1.2.4.1.3 "><p id="p149571054191615"><a name="p149571054191615"></a><a name="p149571054191615"></a>表示该参数值的限制规则，<span id="ph127792551126"><a name="ph127792551126"></a><a name="ph127792551126"></a>详情</span>请参见<a href="#table193601341182112">表4</a>。</p>
    </td>
    </tr>
