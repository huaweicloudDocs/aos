...
-   响应参数
    ...
    **表 3**  参数限制结构说明
    ...
    <td class="cellrowborder" valign="top" width="30.46304630463046%" headers="mcps1.2.4.1.2 "><p id="p985326152717"><a name="p985326152717"></a><a name="p985326152717"></a>Array of integers</p>
    </td>
    <td class="cellrowborder" valign="top" width="46.464646464646464%" headers="mcps1.2.4.1.3 "><p id="p195913383229"><a name="p195913383229"></a><a name="p195913383229"></a>输入值需要符合任意一个合法值</p>
    </td>
    </tr>
